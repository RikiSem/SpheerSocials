...
class PostController extends Controller
{
    ...
    public static function createPost(int $userId, int $socialId, string $text = null, array $files): SocialPost
    {
        $filesPath = json_encode(FileController::saveFiles($files));
        return PostRepository::addPost($userId, $socialId, $text, $filesPath);
    }
